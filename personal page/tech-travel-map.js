...
class TechTravelMap {
    ...
    async init() {
        try {
            ...
            console.log('📍 Travel Data:', this.travelData);
            ...
            console.log('✅ Tech Travel Map initialization completed');
    ...
    createMap() {
        console.log('🗺️ Creating dark theme map...');
        ...
        console.log('✅ Dark theme map creation completed');
    }
    ...
    addTravelMarkers() {
        ...
        console.log('🔴 Red test marker added to Atlanta [33.7490, -84.3880]');
        
        this.travelData.forEach((location, index) => {
            console.log(`📍 创建标记点 ${index + 1}: ${location.name} (Age ${location.age})`);
            ...
            const customIcon = L.divIcon({
                ...
                html: `
                    <div class="marker-container">
                        ...
                        <div class="marker-label">Age ${location.age}</div>
                    </div>
                `,
                iconSize: [40, 40],
                iconAnchor: [20, 20]
            ...
            const marker = L.marker([location.lat, location.lng], {
                icon: customIcon,
                title: `${location.name} (Age ${location.age})`
            }).addTo(this.map);
            
            console.log(`✅ Marker ${location.name} added at coordinates [${location.lat}, ${location.lng}]`);
            ...
            const popup = L.popup({
                ...
                <div class="travel-popup-content">
                    <div class="popup-header">
                        <h3>${location.name}</h3>
                        <span class="age-badge">Age ${location.age}</span>
                    </div>
                    <div class="popup-year">Year ${location.year}</div>
        ...
        console.log(`✅ Travel markers added, total ${this.markers.length} markers`);
    ...
    addResidenceMarker() {
        ...
        console.log(`✅ Residence marker ${this.residenceData.name} added at coordinates [${this.residenceData.lat}, ${this.residenceData.lng}]`);
    }
    ...
    createResidenceRoutes() {
        console.log('🌟 Creating glowing routes from Chengdu to destinations...');
        ...
        this.travelData.forEach((destination, index) => {
            ...
            console.log(`✅ Created route: Chengdu → ${destination.name}`);
        });
        
        console.log(`✅ Diverging routes creation completed, total ${this.residenceData.travelRoutes.length} routes`);
    }
    ...
    addParticleBackground() {
        console.log('✨ Adding particle background...');
    ...
    addTechEffects() {
        console.log('🔮 Adding tech effects...');
        ...
        console.log('✅ Tech effects added');
    }
...
window.TechTravelMap = TechTravelMap;
        ...
        console.log('📦 TechTravelMap Tech Travel Map component loaded');
